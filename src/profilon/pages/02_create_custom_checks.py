...
st.markdown(
    ...
    <div style="display:flex;align-items:flex-end;justify-content:space-between;">
      <div>
        <h1 class="pf-hero__title" style="margin:0">Create Custom Checks</h1>
        <div class="cla-muted" style="margin-top:2px">Compose rules &amp; export YAML</div>
      </div>
      <img class="pf-logo" src="assets/cla_logo_white.png" />
    </div>
...
def _parse_value(key: str, raw: str):
    ...
    # try json for anything that looks like json
...
with cB:
    ...
    if st.session_state.custom_rules:
        st.dataframe(
            [{"table": r["table_name"], "name": r["name"], "function": r["check"]["function"]} for r in st.session_state.custom_rules],
